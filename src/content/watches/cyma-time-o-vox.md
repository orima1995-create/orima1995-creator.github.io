...
deepDive:
  - number: "01"
    ...
    paragraphs:
      ...
      - Time-O-Voxでは、1香箱、2プッシャー、独特の切替機構など、一般的なアラーム腕時計とは異なる構成が採られている。
    citationRefs:
      - "3"
      - "3"
      - 1,3
  - number: "02"
    ...
    paragraphs:
      - R.464は、時計とアラームを一つの香箱で駆動する。アラームを鳴らせば、その分だけ共通のゼンマイを消費する。
      - |-
        ここでいう「矛盾」は、アラームを鳴らしながらクロノメーター試験をするという意味ではない。精度を求める時計に、同じ動力源を使うアラーム機構が同居していることを指す。
        鳴らさなくても噛み合いだけで、
        精度上は不利なのだ。
  ...
  - number: "04"
    ...
    paragraphs:
      - R.464でもう一つ大きな特徴が、冒頭で触れた時刻表示とアラームを一つの香箱から駆動すること。香箱とは、時計を動かすゼンマイを収める部分。
