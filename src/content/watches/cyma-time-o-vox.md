...
deepDive:
  ...
  - number: "02"
    ...
    paragraphs:
      ...
      - 2つのプッシャーは互いに連動し、一方を押すともう一方が押し出される。上・中央・下の3つの位置によって、巻上げ、時刻合わせ、アラーム時刻設定、鳴動の待機を切り替える。R.464では、一つのリューズで複数の操作を行うために、プッシャーで内部の接続先を切り替えている。
      - その切り替えを担うのが、Wippe（揺動レバー）と呼ばれる機構。上下のプッシャーの動きを受けて、リューズからどの歯車へ力を伝えるかを切り替える。つまり、プッシャーで機能を選ぶと、内部ではリューズにつながる歯車そのものが切り替わる。
    citationRefs:
      - "1"
      - "1"
      - "1"
