...
model: "TIME-O-VOX"
  ...
  - "そして、アラームにクロノメーター"
ownersNote:
  image: "/images/cyma-time-o-vox/owners-note-1.webp"
  imageParts:
    - "/images/cyma-time-o-vox/owners-note-1.webp"
    - "/images/cyma-time-o-vox/owners-note-2.webp"
    - "/images/cyma-time-o-vox/owners-note-3.webp"
    - "/images/cyma-time-o-vox/owners-note-4.webp"
  zoomHref: "/cyma-time-o-vox/owners-note/"
  lead:
    - "鳴る黄金のクロノメーター"
    - "正面はドレスウォッチ"
    - "横顔はクロノグラフ"
...
deepDive:
  - number: "01"
    ...
    paragraphs:
      ...
      - "1871年にはHenri Sandozがル・ロックルでHenri Sandoz & Cieを設立。1891年、Sandozはタヴァンヌへ移り、Tavannes Watch Co.を立ち上げた。"
  ...
  - number: "02"
    ...
    paragraphs:
      ...
      - "互いに連動し、一方を押すともう一方が押し出される。上・中央・下の3つの位置によって、巻上げ、時刻合わせ、アラーム時刻設定、鳴動の待機を切り替える。"
      - "内部では、Wippe（揺動レバー）と呼ばれる上下の部品が、リューズからどの輪列へ力を伝えるかを切り替えている。"
      - "上側のプッシャーを押した状態では、通常の巻上げと時刻合わせ。下側を押した状態では、アラーム時刻の設定。そして両プッシャーが中央に揃った時だけ、アラーム機構が解放される。"
      - "つまりR.464では、プッシャーを押して機能を選ぶというより、内部の接続先そのものを切り替えている。"
      - "一つの香箱なのに、リューズは回らない。"
      - "R.464は、時刻表示とアラームを一つの香箱から駆動する。"
      - "普通に考えると、アラームが香箱を勢いよく解放すれば、その力が巻上げ輪列へ逆流し、リューズまで回りそうに見える。"
      - "しかしR.464では、鳴動時に巻上げ中間車が巻上げ側から切り離される。そのため、アラームが動いている間も冠車、巻上げピニオン、巻真は駆動されない。"
      - "同じ香箱を使っているのに、アラームが鳴ってもリューズは回らない。"
      - "単一香箱という構成を成立させるために、輪列側でかなり巧妙な処理をしている。"
      - "鳴らしすぎない。"
      - "一つの香箱を時刻とアラームで共有する以上、アラームにエネルギーを使いすぎれば、その後の時計の駆動時間まで削ってしまう。"
      - "そこでR.464には、アラームの鳴動時間を制限する機構が組み込まれている。"
      - "資料では、アラームの鳴動時間はおよそ6〜10秒とする記録がある。鳴動時間を制限することで、時計側のパワーリザーブを残す設計になっている。再びアラームを使うには、もう一度巻き上げる必要がある。"
