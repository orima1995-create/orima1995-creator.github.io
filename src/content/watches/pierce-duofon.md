...
specimenGallery:
  - image: "/images/pierce-duofon/gallery/pierce-duofon-wrist-front.webp"
    label: "正面（リストショット）"
    alt: "Pierce Duofon 掲載個体の正面 リストショット"
  - image: "/images/pierce-duofon/gallery/pierce-duofon-signal-white.webp"
    label: "Signal（白・静音）"
    alt: "Pierce Duofon Signal 白表示 静音設定"
  - image: "/images/pierce-duofon/gallery/pierce-duofon-wecker-red.webp"
    label: "Wecker（赤・大音量）"
    alt: "Pierce Duofon Wecker 赤表示 大音量設定"
  - image: "/images/pierce-duofon/gallery/pierce-duofon-caseback.webp"
    label: "裏面"
    alt: "Pierce Duofon 掲載個体の裏蓋"
video:
